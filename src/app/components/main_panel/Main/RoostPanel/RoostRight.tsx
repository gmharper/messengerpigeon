        ...
        <div className='flex flex-row gap-1'>
            ...
            <>
                <button 
                    ...
                    data-tooltip-content='Open Profile Page'
                    data-tooltip-place="bottom-start"
                >
                    <UserIcon className='text-black' />    
                </button> 
                <Tooltip id={'profile'} style={{ backgroundColor:'black', opacity:'100%', color:'white' }} />
            </> : 
            ...
            <>
                ...
                <Tooltip id={'follow'} style={{ backgroundColor:'black', opacity:'100%', color:'white' }}/>
            </> :
            <></>
            }
